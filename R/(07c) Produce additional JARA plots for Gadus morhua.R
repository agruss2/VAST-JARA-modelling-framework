###############################################################################################################################
##
##  (07c) This script produces additional JARA plots for Gadus morhua
##  
###############################################################################################################################
...
GL <- predfl[[1]]$Mean_pred["G"] #### 9.233427 years
...
m1 <- 0
m2 <- 3.35 #### Needs to be adjusted for each species individually

###############################################################################################################################
##
##  (07b) This script produces additional JARA plots for Squalus acanthias
##  
###############################################################################################################################
...
GL <- predfl[[1]]$Mean_pred["G"] #### 23.00901 years
GL <- 17 #### We decided to use 17 years instead - value from the latest ICUN Red List assessment
...
m1 <- 0
m2 <- 4.75 #### Needs to be adjusted for each species individually

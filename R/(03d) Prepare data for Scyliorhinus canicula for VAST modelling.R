##############################################################################################################################
## 
##  (03d) This script prepares data for Scyliorhinus canicula for VAST modelling
## 
##############################################################################################################################
...
nrow( Species_data ) #### 2130 records
...
summary( Species_data$wgt_cpue ) #### 7 NA's
Species_data <- Species_data[!is.na( Species_data$wgt_cpue ),] 
nrow( Species_data ) #### 14 570 records 
Species_data$encounter <- ifelse( Species_data$wgt_cpue > 0, 1, 0 )
table( Species_data$encounter, Species_data$year ) 
####     1983 1984 1985 1986 1987 1988 1989 1990 1991 1992 1993 1994 1995 1996 1997
####   0  275  359  418  435  446  386  400  358  393  357  347  340  324  304  334
####   1   13   20   19   19   10   16   27   21   27   18   27   23   16   25   29
####    
####     1998 1999 2000 2001 2002 2003 2004 2005 2006 2007 2008 2009 2010 2011 2012
####   0  374  308  339  378  358  350  325  326  328  298  319  333  286  313  279
####   1   30   50   47   52   62   67   50   64   53   75   73   65   88   84  110
####    
####     2013 2014 2015 2016 2017 2018 2019 2020
####   0  285  235  273  261  255  258  253  237
####   1  108  105  101   99  122  106   99  103
...
sort( unique( Non_zero_species_data$wgt_cpue ) ) #### Values above 2500 kg/km2 identified as outliers (11 records)
Species_data <- Species_data[Species_data$wgt_cpue <= 2500,]
Non_zero_species_data <- Species_data[Species_data$wgt_cpue > 0,]
summary( Non_zero_species_data$wgt_cpue )
hist( Non_zero_species_data$wgt_cpue )
nrow( Species_data ) #### 14 559 records 
table( Species_data$encounter, Species_data$year )
####     1983 1984 1985 1986 1987 1988 1989 1990 1991 1992 1993 1994 1995 1996 1997
####   0  275  359  418  435  446  386  400  358  393  357  347  340  324  304  334
####   1   13   20   19   19   10   16   27   21   27   18   27   23   16   25   29
...
####     1998 1999 2000 2001 2002 2003 2004 2005 2006 2007 2008 2009 2010 2011 2012
####   0  374  308  339  378  358  350  325  326  328  298  319  333  286  313  279
####   1   30   50   47   52   62   67   50   64   53   75   72   65   88   84  109
####    
####     2013 2014 2015 2016 2017 2018 2019 2020
####   0  285  235  273  261  255  258  253  237
####   1  106  104   99   98  121  106   99  101

##############################################################################################################################
## 
##  (05b) This script plots VAST results for Squalus acanthias
##  
##############################################################################################################################
...
graphics.off()
MannKendall( Relative_Biomass ) #### tau = -0.354, 2-sided pvalue =0.0018219
...
graphics.off()
MannKendall( SD_mean_Z_ctm[1,,1,'Estimate'] ) #### tau = 0.189, 2-sided pvalue =0.097017
...
graphics.off()
MannKendall( SD_mean_Z_ctm[1,,2,'Estimate'] ) #### tau = 0.357, 2-sided pvalue =0.0016724
...
graphics.off()
MannKendall( SD_log_effective_area_ctl[1,,1,1] ) tau = -0.181, 2-sided pvalue =0.11318

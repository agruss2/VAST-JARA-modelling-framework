##############################################################################################################################
## 
##  (05a) This script plots VAST results for Amblyraja radiata
##  
##############################################################################################################################
...
graphics.off()
MannKendall( Relative_Biomass ) #### tau = -0.59, 2-sided pvalue =1.9424e-07
...
graphics.off()
MannKendall( SD_mean_Z_ctm[1,,1,'Estimate'] ) #### tau = 0.528, 2-sided pvalue =3.3379e-06
...
graphics.off()
MannKendall( SD_mean_Z_ctm[1,,2,'Estimate'] ) #### tau = 0.152, 2-sided pvalue =0.18266
...
graphics.off()
MannKendall( SD_log_effective_area_ctl[1,,1,1] ) #### tau = -0.411, 2-sided pvalue =0.0002938

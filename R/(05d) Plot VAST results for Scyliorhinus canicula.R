##############################################################################################################################
## 
##  (05d) This script plots VAST results for Scyliorhinus canicula
##  
##############################################################################################################################
...
graphics.off()
MannKendall( Relative_Biomass ) #### tau = 0.755, 2-sided pvalue =< 2.22e-16
...
graphics.off()
MannKendall( SD_mean_Z_ctm[1,,1,'Estimate'] ) #### tau = 0.605, 2-sided pvalue =1.1921e-07
...
graphics.off()
MannKendall( SD_mean_Z_ctm[1,,2,'Estimate'] ) #### tau = -0.57, 2-sided pvalue =4.9366e-07
...
graphics.off()
MannKendall( SD_log_effective_area_ctl[1,,1,1] ) #### tau = -0.531, 2-sided pvalue =2.9146e-06

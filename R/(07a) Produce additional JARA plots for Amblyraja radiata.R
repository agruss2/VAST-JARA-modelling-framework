###############################################################################################################################
##
##  (07a) This script produces additional JARA plots for Amblyraja radiata
##  
###############################################################################################################################
...
#### Define the "round_realsum" function
...
GL <- predfl[[1]]$Mean_pred["G"] #### 15.00415 years
GL <- 10.6 #### We decided to use 10.6 years instead - value from the latest ICUN Red List assessment
...
m1 <- 0
m2 <- 4.25 #### Needs to be adjusted for each species individually
...
plot( 0, 0, ylim = c( m1, m2 ), xlim = Xlim, ylab = ylab, xlab = xlab, 

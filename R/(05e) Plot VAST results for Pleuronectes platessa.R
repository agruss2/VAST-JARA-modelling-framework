##############################################################################################################################
## 
##  (05e) This script plots VAST results for Pleuronectes platessa
##  
##############################################################################################################################
...
graphics.off()
MannKendall( Relative_Biomass ) #### tau = 0.428, 2-sided pvalue =0.00016224
...
graphics.off()
MannKendall( SD_mean_Z_ctm[1,,1,'Estimate'] ) #### tau = -0.215, 2-sided pvalue =0.059324
...
graphics.off()
MannKendall( SD_mean_Z_ctm[1,,2,'Estimate'] ) #### tau = 0.34, 2-sided pvalue =0.0027705
...
graphics.off()
MannKendall( SD_log_effective_area_ctl[1,,1,1] ) #### tau = 0.0612, 2-sided pvalue =0.59749
